...
export default function Form() {
	...
	return (
		<>
			<p>Masukkan dataset mengenai skripsi pada kampus atmaluhur :</p>
			<Textarea
				placeholder=" contoh : sampul Penjilidan skripsi untuk jurusan Teknik Informatika
BERWARNA ORANGE CERAH (kode warna: Saffron)"
				className="h-96"
				ref={inputRef}
			/>
